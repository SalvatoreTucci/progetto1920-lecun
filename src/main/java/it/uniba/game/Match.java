...
class Match {
	...
	// specific method which handles the situation where the move is a capture <br>
	...
	private Boolean checkKingThreat(Move toMove) {
		...
		Vector<Coordinates> squaresToCheck;			//vector containing the coordinates for possibles threatning pieces  <br>
